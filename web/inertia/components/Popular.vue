      ...
      <div class="col-md-7 col-lg-8">
        <div class="h4 mb-3">Популярный товар</div>
          <div class="row g-3 mb-3">
            ...
            <div class="col-12">
              <label for="letter" class="form-label">Выбери букву, где находится штрихкод или SKU</label>
              <select class="form-select" v-model="letter" @change="form.letter = $event.target.value">
            ...
            <div class="col-12">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="barcode" v-model="type"  @click="form.type = $event.target.value">
